    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
          ...
          <QuickLink to="/teacher/mark-entry"   label="Mark Entry"      desc="Enter or update exam marks"   icon={<EditIcon />} />
          <QuickLink to="/teacher/profile"      label="My Profile"      desc="View your account details"    icon={<UserIcon />} />
        </div>
      </div>
    </div>
  );
