  ...
  <div className="space-y-4">
    <div>
      ...
      <select name="name" value={form.name} onChange={onChange}
        className={`w-full px-3 py-2 text-sm border rounded-lg focus:outline-none focus:ring-2 focus:ring-red-400 focus:border-transparent ${errors.name ? 'border-red-400' : 'border-gray-200'}`}>
    ...
    <div>
      ...
      <input type="time" name="startTime" value={form.startTime} onChange={onChange}
        className={`w-full px-3 py-2 text-sm border rounded-lg focus:outline-none focus:ring-2 focus:ring-red-400 focus:border-transparent ${errors.startTime ? 'border-red-400' : 'border-gray-200'}`}
      />
    ...
    <div>
      ...
      <input type="time" name="endTime" value={form.endTime} onChange={onChange}
        className={`w-full px-3 py-2 text-sm border rounded-lg focus:outline-none focus:ring-2 focus:ring-red-400 focus:border-transparent ${errors.endTime ? 'border-red-400' : 'border-gray-200'}`}
      />
...
const buildColumns = (onEdit, onDelete) => [
  {
    ...
    header: 'Slot Name',
    render: (row) => (
      <span className="inline-block px-2 py-0.5 rounded-full text-xs font-semibold bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400">
        {row.name ?? '—'}
      </span>
    ),
  },
...
const TimeSlotsPage = () => {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Time Slots"
        subtitle="Define and manage school period time slots globally"
        action={
